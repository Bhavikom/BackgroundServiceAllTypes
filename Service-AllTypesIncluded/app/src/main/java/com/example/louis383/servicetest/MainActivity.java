...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button startItentService, startClassicService;
    private Button openBinderServiceActivity, messageBinderServiceButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startItentService = (Button) findViewById(R.id.start_intent_service);
        startItentService.setOnClickListener(this);
        startClassicService = (Button) findViewById(R.id.start_classic_service);
        startClassicService.setOnClickListener(this);
        openBinderServiceActivity = (Button) findViewById(R.id.open_binder_services_activity_btn);
        openBinderServiceActivity.setOnClickListener(this);
