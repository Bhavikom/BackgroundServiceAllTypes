package com.pedromassango.jobschedulersample.Database;
...
import com.pedromassango.jobschedulersample.Utilit.Config;
...
public class DatabaseQueryClass {
    ...
    public long insertStudent(Student student){
        ...
        contentValues.put(Config.COLUMN_TIME, student.getName());
        contentValues.put(Config.COLUMN_SOURCE, student.getRegistrationNumber());
        contentValues.put(Config.COLUMN_JOB_ID, student.getPhoneNumber());
            ...
            if(cursor!=null)
                if(cursor.moveToFirst()){
                    ...
                    do {
                        ...
                        String name = cursor.getString(cursor.getColumnIndex(Config.COLUMN_TIME));
                        String registrationNumber = cursor.getString(cursor.getColumnIndex(Config.COLUMN_SOURCE));
                        String email = cursor.getString(cursor.getColumnIndex(Config.COLUMN_STUDENT_EMAIL));
                        String phone = cursor.getString(cursor.getColumnIndex(Config.COLUMN_JOB_ID));
